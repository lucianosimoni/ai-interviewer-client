        ...
        <section className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          ...
          <div className="place-self-center lg:col-span-7">
            ...
            <div className="flex flex-row justify-center lg:justify-start">
              ...
              {/* LEARN MORE */}
              <Link to={"/about"}>
                <button className="items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                  Learn more
                </button>
              </Link>
            </div>
