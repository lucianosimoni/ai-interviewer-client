export default function Help() {
  return (
    <main className="bg-gray-50 dark:bg-gray-900">
      <div className="py-8 px-4 mx-auto h-screen max-w-screen-md text-center lg:py-16 lg:px-12 flex-col flex justify-center items-center ">
        <svg
        ...
        <a
          className="bg-slate-800 rounded-full w-fit px-6"
          target="_blank"
        ...
        >
          <p className="font-light text-gray-500 md:text-lg xl:text-xl dark:text-gray-400">
            Get in touch with <b>Luciano</b>{" "}
            <b className="text-blue-500">here</b>.
          </p>
        </a>
      </div>
    </main>
