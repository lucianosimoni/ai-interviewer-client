                      ...
                      <tr key={index} className="border-b dark:border-gray-700">
                        ...
                        <td className="px-4 py-3">
                          <Link
                            ...
                            className="items-center justify-center px-5 py-1 text-base font-normal text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800"
                          >
                            Open
                          </Link>
                        </td>
