      ...
      <main className="bg-white dark:bg-gray-900 h-screen flex">
        <section className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          ...
          <div className="place-self-center lg:col-span-7">
            ...
            {/* DESCRIPTION */}
            <p className="text-center md:text-left max-w-2xl mb-2 font-light text-gray-500 lg:mb-2 md:text-lg lg:text-xl dark:text-gray-400">
              Welcome to AI Interviewer, a powerful platform that leverages the
              capabilities of <b>artificial intelligence</b> to provide an
              exceptional interviewing experience.
            </p>
            <p className="text-center md:text-left max-w-2xl mb-2 font-light text-gray-500 lg:mb-2 md:text-lg lg:text-xl dark:text-gray-400">
              With our AI-powered interviewer, we aim to streamline and enhance
              the traditional interview process by asking relevant and
              thought-provoking questions to candidates. Gone are the days of
              generic interviews; our <b>intelligent system</b> ensures that
              candidates are challenged and stimulated, bringing out their true
              potential.
            </p>
            <p className="text-center md:text-left max-w-2xl mb-4 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              AI Interviewer is here to empower you and drive meaningful
              conversations. <b>Join us</b> on this cutting-edge journey as we
              redefine the future of interviews with innovation and efficiency.
            </p>
